/* ============================================================
   ...
   Passwords can be set manually (validated against the same
   complexity rules as self-service change-password) or system-
   ...
   same as Workflow Admin — this screen adds create, profile edit,
   password reset, and permanent removal on top of that.
   ============================================================ */
      ...
      <div className="panel-head">
        <div>
          ...
          <div className="panel-sub">
            Add, change, or permanently remove local accounts. Passwords can be set manually or
            system-generated; either way the account must change it at first login.
          </div>
        </div>
