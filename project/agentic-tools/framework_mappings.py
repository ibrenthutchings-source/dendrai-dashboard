...
16, "Reviews Risk and Performance"). Only these 8 INFRA-* controls carry a
coso_component today — every other control_id in controls_catalog is an
honest gap, not backfilled with a guess, per this file's own policy above.
"""
