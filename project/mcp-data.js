...
window.MCP = (function () {
  ...
  /** Deployment environment name + dev-gating flag: isDev covers Exception Management's
   *  nav gating (Development, or sandbox/uat opted in via EXCEPTION_MGMT_LOCAL_DEV). */
